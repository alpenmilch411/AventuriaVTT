...
export const MANEUVERS = [
  ...
  { id: 'hammerschlag', label: 'Hammerschlag', atMod: -4, paMod: 0, tpMod: 4, halveRS: true, desc: 'AT-4, +4 TP und RS des Gegners halbiert. Benötigt Hiebwaffen, Zweihandhiebwaffen oder Zweihandschwerter.', requiredSF: 'Hammerschlag', techniques: ['Hiebwaffen', 'Zweihandhiebwaffen', 'Zweihandschwerter'], type: 'spezial' },
  ...
  { id: 'windmuehle', label: 'Windmühle', atMod: -4, paMod: -99, tpMod: 0, desc: 'AT-4 gegen alle Gegner in Nahkampfreichweite (max 3). Keine PA.', requiredSF: 'Windmühle', techniques: ['Zweihandschwerter', 'Zweihandhiebwaffen', 'Stangenwaffen'], noPAThisRound: true, type: 'spezial' },
