...
def _create_test_characters(session: Session, user_ids: Dict[str, str]):
    ...
    characters = [
        ...
        },
        {
            ...
            "derived_values": {"LeP_max": 24, "AsP_max": 41, "KaP_max": 0, "INI_basis": 10, "GS": 8, "AW": 6, "SK": 3, "ZK": 1, "Schip": 3},
            ...
            "advantages": {"Gutaussehend": {"ap": 10}, "Zauberer": {"ap": 25}},
            "disadvantages": {"Schlechte Eigenschaft (Neugier)": {"ap": 5}, "Körperliche Auffälligkeit": {"ap": 5}},
            "current_vitals": {"lep": 24, "asp": 41, "kap": 0, "schip": 3},
            "basis_inventory": [
        ...
        },
        {
            ...
            "derived_values": {"LeP_max": 28, "AsP_max": 0, "KaP_max": 40, "INI_basis": 9, "GS": 8, "AW": 5, "SK": 2, "ZK": 2, "Schip": 3},
            ...
            "advantages": {"Geweihter": {"ap": 25}, "Hohe Karmalkraft I": {"ap": 20}},
            "disadvantages": {"Prinzipientreue": {"ap": 10}, "Mitleid": {"ap": 10}},
            "current_vitals": {"lep": 28, "asp": 0, "kap": 40, "schip": 3},
            "basis_inventory": [
        ...
        },
        {
            ...
            "advantages": {"Fuchssinn": {"ap": 10}, "Dunkelsicht I": {"ap": 10}},
            "disadvantages": {"Schlechte Eigenschaft (Neugier)": {"ap": 5}, "Angst vor (enge Räume)": {"ap": 10}},
            "current_vitals": {"lep": 26, "asp": 0, "kap": 0, "schip": 3},
            "basis_inventory": [
